...
class OffboardingWorkflow(Base):
    ...
    departure_reason = Column(SAEnum(DepartureReason, name="departure_reason_type"), nullable=False)
    departure_date = Column(Date, nullable=False)
    status = Column(SAEnum(WorkflowStatus, name="workflow_status_type"), default=WorkflowStatus.initiated)
...
class OffboardingStep(Base):
    ...
    step_type = Column(SAEnum(StepType, name="step_type"), nullable=False)
