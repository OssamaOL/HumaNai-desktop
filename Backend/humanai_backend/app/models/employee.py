...
class Employee(Base):
    ...
    contract_type = Column(SAEnum(ContractType, name="contract_type"), default=ContractType.cdi)
    salary_band = Column(Text, nullable=True)  # encrypted
    status = Column(SAEnum(EmployeeStatus, name="employee_status_type"), default=EmployeeStatus.actif)
